...
Usage (di host):
  docker exec stock_app python scripts/run_analysis.py
  docker exec stock_app python scripts/run_analysis.py BBCA BBRI TLKM
"""
import logging
import os
import sys
...
def main():
    ...
    result = run_full_analysis(universe=tickers)
