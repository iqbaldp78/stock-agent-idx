      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-card backdrop-blur-md border border-border rounded-2xl p-6 hover:bg-white/5 transition duration-300">
          <div className="flex justify-between items-start mb-4">
            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${stats.market_outlook === 'Bullish' ? 'bg-profit/10 text-profit' : stats.market_outlook === 'Bearish' ? 'bg-loss/10 text-loss' : 'bg-slate-500/10 text-secondary'}`}>
          ...
          <h3 className={`text-3xl font-bold ${stats.market_outlook === 'Bullish' ? 'text-profit' : stats.market_outlook === 'Bearish' ? 'text-loss' : 'text-secondary'}`}>
        ...
        <div className="bg-card backdrop-blur-md border border-border rounded-2xl p-6 hover:bg-white/5 transition duration-300">
          <div className="flex justify-between items-start mb-4">
            <div className="w-10 h-10 rounded-full bg-info/10 flex items-center justify-center text-info font-bold">⚖</div>
